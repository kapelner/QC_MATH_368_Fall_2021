...
\title{MATH 368/621 Fall \the\year~ Homework \#1}

\author{Professor Adam Kapelner} %STUDENTS: write your name here

\iftoggle{professormode}{
\date{Due by email 11:59PM Sunday, September 5, \the\year \\ \vspace{0.5cm} \small (this document last updated \today ~at \currenttime)}
}
...
\hardsubproblem{Let $X_1 \sim \binomial{n}{p}$ independent of $X_2 \sim \binomial{n}{p}$. Find the PMF of the sum of $T = X_1 + X_2$ using a convolution.}\spc{13}
